//*****************************************************************************
// Program:	 LaPi Development Board Demo Code Q111-Fast_UART (512k Baud!)
...
//In this example set, the Q111 micro sends data to the Q112 micro, so they
...
// Q111 MICRO CONNECTIONS FOR (LaPi Plug 'n Play Board)
	#define LCD_RX_pin	PB1D	//2013-04-18 (LaPi Plug 'n Play Board)
...
#define UART_BAUDRATE		( UART_BR_512000BPS) 	// Data Bits Per Second - Tested at rates from 2400bps to 512000bps!
...
unsigned char 	Q111ToQ112[22] = {"ABCDEFG1234567890xyz\n\r"};	//Used for Testing the UART Q111 <=> Q112
unsigned int	UART_VAR;

char char_a;		// -128 to 127
unsigned char uchar;	// 0-255
int i, inta, table [100];	// -32,768 to 32767
...
// ====================  START EXAMPLE OF TX LOOP ===================================================
TX_Loop:
	main_clrWDT();
	
	uart_startSend(Q111ToQ112, 22, _funcUartFin);	//Send Array of Data...
...
goto TX_Loop; //Endless loop...
// ====================  END EXAMPLE OF TX LOOP =====================================================
