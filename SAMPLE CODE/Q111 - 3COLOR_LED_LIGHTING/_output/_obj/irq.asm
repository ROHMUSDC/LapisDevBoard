...
CFILE 0003H 00000049H "irq\\irq.h"
CFILE 0000H 00000132H "irq\\irq.c"
...
;;{
CLINEA 0000H 0001H 0095H 0001H 0001H
	push	er4
CBLOCK 0 2 149
...
CLINEA 0000H 0001H 00A9H 0002H 002EH
	mov	er4,	#0 
_$L3 :
CBLOCK 0 3 169

;;		_sIrqHdr[irqNo] = _intNullHdr;
CLINEA 0000H 0001H 00AAH 0003H 0020H
	mov	er0,	er4
	add	er0,	er4
...
;;	for( irqNo = 0; irqNo < IRQ_SIZE; irqNo++ ) {
CLINEA 0000H 0000H 00A9H 0002H 002EH
	add	er4,	#1 
	cmp	r4,	#01fh
	cmpc	r5,	#00h
	blts	_$L3
...
;;	__DI();
CLINEA 0000H 0001H 00C3H 0002H 0008H
	di
CBLOCKEND 2 2 196
...
CLINEA 0000H 0001H 00D7H 0002H 0029H
	cmp	r0,	#01fh
	blt	_$L10
CBLOCK 4 3 215

;;		return ( IRQ_R_ERR_INTNO );
CLINEA 0000H 0001H 00D8H 0003H 001DH
	mov	er0,	#-1
CBLOCKEND 4 3 217
CBLOCKEND 4 2 226
...
;;		_sIrqHdr[intNo] = func;
CLINEA 0000H 0001H 00DCH 0003H 0019H
	mov	r0,	r8
	mov	r1,	#00h
	add	er0,	er0
...
;;	else {
CLINEA 0000H 0001H 00DEH 0002H 0007H
	bal	_$L14
_$L12 :
CBLOCK 4 5 222

;;		_sIrqHdr[intNo] = _intNullHdr;
CLINEA 0000H 0001H 00DFH 0003H 0020H
	mov	r0,	r8
	mov	r1,	#00h
	add	er0,	er0
	mov	r2,	#BYTE1 OFFSET __intNullHdr
...
;;}
CLINEA 0000H 0000H 00F2H 0001H 0001H
	rti
CBLOCKEND 6 1 242
CFUNCTIONEND 6
...
;;}
CLINEA 0000H 0000H 00FEH 0001H 0001H
	rt
CBLOCKEND 7 1 254
CFUNCTIONEND 7
...
;;	_sIrqHdr[intNo]();
CLINEA 0000H 0001H 010CH 0002H 0013H
	mov	r1,	#00h
	add	er0,	er0
...
CLINEA 0000H 0001H 0116H 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intPA1INT(void)	{	_branchHdr(IRQ_NO_PA1INT);		}
CLINEA 0000H 0000H 0116H 0001H 003CH
	mov	r0,	#03h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 0118H 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intPB0INT(void)	{	_branchHdr(IRQ_NO_PB0INT);		}
CLINEA 0000H 0000H 0118H 0001H 003CH
	mov	r0,	#05h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 011CH 0001H 003EH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intSIO0INT(void)	{	_branchHdr(IRQ_NO_SIO0INT);		}
CLINEA 0000H 0000H 011CH 0001H 003EH
	mov	r0,	#09h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 011EH 0001H 003EH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intI2CSINT(void)	{	_branchHdr(IRQ_NO_I2CSINT);		}
CLINEA 0000H 0000H 011EH 0001H 003EH
	mov	r0,	#0bh
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 011FH 0001H 003EH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intI2CMINT(void)	{	_branchHdr(IRQ_NO_I2CMINT);		}
CLINEA 0000H 0000H 011FH 0001H 003EH
	mov	r0,	#0ch
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 0122H 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intUA0INT(void)	{	_branchHdr(IRQ_NO_UA0INT);		}
CLINEA 0000H 0000H 0122H 0001H 003CH
	mov	r0,	#0fh
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 0123H 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intUA1INT(void)	{	_branchHdr(IRQ_NO_UA1INT);		}
CLINEA 0000H 0000H 0123H 0001H 003CH
	mov	r0,	#010h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 0125H 0001H 003EH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intCMP1INT(void)	{	_branchHdr(IRQ_NO_CMP1INT);		}
CLINEA 0000H 0000H 0125H 0001H 003EH
	mov	r0,	#012h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 012BH 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intPWDINT(void)	{	_branchHdr(IRQ_NO_PWDINT);		}
CLINEA 0000H 0000H 012BH 0001H 003CH
	mov	r0,	#018h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 012CH 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intPWEINT(void)	{	_branchHdr(IRQ_NO_PWEINT);		}
CLINEA 0000H 0000H 012CH 0001H 003CH
	mov	r0,	#019h
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 012DH 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intPWFINT(void)	{	_branchHdr(IRQ_NO_PWFINT);		}
CLINEA 0000H 0000H 012DH 0001H 003CH
	mov	r0,	#01ah
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 012EH 0001H 003FH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intT128HINT(void)	{	_branchHdr(IRQ_NO_T128HINT);	}
CLINEA 0000H 0000H 012EH 0001H 003FH
	mov	r0,	#01bh
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 012FH 0001H 003EH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intT32HINT(void)	{	_branchHdr(IRQ_NO_T32HINT);		}
CLINEA 0000H 0000H 012FH 0001H 003EH
	mov	r0,	#01ch
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 0130H 0001H 003EH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intT16HINT(void)	{	_branchHdr(IRQ_NO_T16HINT);		}
CLINEA 0000H 0000H 0130H 0001H 003EH
	mov	r0,	#01dh
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
...
CLINEA 0000H 0001H 0131H 0001H 003CH
	push	lr, ea
	push	xr0
	l	r0,	DSR
	push	r0
...
;;static void _intT2HINT(void)	{	_branchHdr(IRQ_NO_T2HINT);		}
CLINEA 0000H 0000H 0131H 0001H 003CH
	mov	r0,	#01eh
	bl	__branchHdr
	pop	r0
	st	r0,	DSR
